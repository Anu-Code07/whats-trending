            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Add your Groq API key to get AI-powered "Why it matters" explanations.',
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
                          color: AppColors.textSecondary,
                        ),
                  ),
                    ...
                    children: [
                      Expanded(
                        child: FilledButton(
                          ...
                          child: Text(_keySaved ? 'Saved ✓' : 'Save Groq key'),
                        ),
                      ),
                      if (storage.hasGroqKey) ...[
                        const SizedBox(width: 8),
                        Icon(Icons.check_circle, color: AppColors.relevanceHigh, size: 20),
                      ],
                    ],
                  ),
                  const SizedBox(height: 28),
